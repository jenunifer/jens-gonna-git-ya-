...
require_once("DAO/HostNoteCriteriaDAO.php");

/**
 * The HostNoteCriteria class extends HostNoteDAOCriteria and is used
 ...
 * @version 1.0
 */
class HostNoteCriteria extends HostNoteCriteriaDAO
{
