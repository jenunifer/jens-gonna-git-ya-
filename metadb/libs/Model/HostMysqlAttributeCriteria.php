...
require_once("DAO/HostMysqlAttributeCriteriaDAO.php");

/**
 * The HostMysqlAttributeCriteria class extends HostMysqlAttributeDAOCriteria and is used
 ...
 * @version 1.0
 */
class HostMysqlAttributeCriteria extends HostMysqlAttributeCriteriaDAO
{
