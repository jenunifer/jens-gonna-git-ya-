...
require_once("DAO/CnameServerCriteriaDAO.php");

/**
 * The CnameServerCriteria class extends CnameServerDAOCriteria and is used
 ...
 * @version 1.0
 */
class CnameServerCriteria extends CnameServerCriteriaDAO
{
