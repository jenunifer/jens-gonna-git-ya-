...
require_once("DAO/ViphostCriteriaDAO.php");

/**
 * The ViphostCriteria class extends ViphostDAOCriteria and is used
 ...
 * @version 1.0
 */
class ViphostCriteria extends ViphostCriteriaDAO
{
