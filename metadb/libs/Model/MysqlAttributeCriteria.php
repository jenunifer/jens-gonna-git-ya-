...
require_once("DAO/MysqlAttributeCriteriaDAO.php");

/**
 * The MysqlAttributeCriteria class extends MysqlAttributeDAOCriteria and is used
 ...
 * @version 1.0
 */
class MysqlAttributeCriteria extends MysqlAttributeCriteriaDAO
{
