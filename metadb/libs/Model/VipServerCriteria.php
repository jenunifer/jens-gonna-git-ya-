...
require_once("DAO/VipServerCriteriaDAO.php");

/**
 * The VipServerCriteria class extends VipServerDAOCriteria and is used
 ...
 * @version 1.0
 */
class VipServerCriteria extends VipServerCriteriaDAO
{
