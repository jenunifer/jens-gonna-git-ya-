...
/**
 * AppBaseController is the backend controller
 * the front controllers inherit.  it is not necessary to use this
 * class or any code; you can use it for application-wide
...
class AppBaseController extends Controller
{
	...
	/**
	 * Return the default params used when rendering objects as JSON
	 * @return array
	 */
